...
@if ($b_image != null)
  <img src="{{ asset("storage/$b_image->home_about_one_image") }}" alt="Image" /> 
    <p>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card card-body">
        <form role="form" action="{{ url('dashboard/about/one/image/store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
